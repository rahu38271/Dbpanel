    ...
    public class CustomContext:DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
                ...
                string MasterDBconstr = "Data Source=192.168.0.107;Database=IndiaData;User Id=Maharashtra_New; Password=ElectionAlerts@1112;pooling=false;Connection Timeout=3600";
